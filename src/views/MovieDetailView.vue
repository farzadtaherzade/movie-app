...
axios
  .get(
    `https://api.themoviedb.org/3/movie/${paramsId}?api_key=a67aeb2a76989aba8a19ccda9d5879ba&language=en-US`
  )
  .then((res) => {
...
axios
  .get(
    `https://api.themoviedb.org/3/movie/${paramsId}/videos?api_key=a67aeb2a76989aba8a19ccda9d5879ba&language=en-US`
  )
  .then((res) => {
    moviesTrailer.value =
...
axios
  .get(
    `https://api.themoviedb.org/3/movie/${paramsId}/credits?api_key=a67aeb2a76989aba8a19ccda9d5879ba&language=en-US`
  )
  .then((res) => {
