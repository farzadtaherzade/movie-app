            ...
            <div class="right">
                <div class="title-save-movie">
                    ...
                    <div class="imdb-wrap">
                        ...
                        <img src="https://ia.media-imdb.com/images/M/MV5BMTk3ODA4Mjc0NF5BMl5BcG5nXkFtZTgwNDc1MzQ2OTE@._V1_.png"
                            alt="imdb" class="imdb" />
                    </div>
                </div>
                ...
                <div class="button">
                    <button class="add-fav"> <img :src="PlaySvg" alt="PlaySvg" style=""> <strong>WATCH TRAILER</strong></button>
